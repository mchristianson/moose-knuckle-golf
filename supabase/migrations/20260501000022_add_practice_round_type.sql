-- Add 'practice' to the round_type enum
ALTER TYPE round_type ADD VALUE IF NOT EXISTS 'practice';

-- Drop and recreate season leaderboard function to exclude practice rounds
DROP FUNCTION IF EXISTS get_season_leaderboard(integer);

CREATE FUNCTION get_season_leaderboard(p_season_year INTEGER)
RETURNS TABLE (
    team_id UUID,
    team_name TEXT,
    team_number INTEGER,
...
-- Update handicap function to exclude practice rounds
