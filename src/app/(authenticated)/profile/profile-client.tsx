...
export function ProfileClient({ isImpersonating }: Props) {
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-6">
      ...
      {isImpersonating && (
        <Card variant="elevated" className="mb-6 bg-amber-900/30 border-amber-700">
          <p className="text-amber-300 text-sm">
            You are currently impersonating another user. This page shows your own account settings.
          </p>
        </Card>
      )}
